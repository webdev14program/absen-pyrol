                                ...
                                <tbody>
                                    ...
                                    foreach ($mutasi as $d) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($d->status_mutasi == 'diajukan') { ?>
                                                    <a onclick="return confirm('apakah anda yakin ingin menerima pengajuan mutasi ini?')" href="<?= base_url('manajer/mutasi_terima/' . $d->no_urut) ?>" class="btn btn-primary btn-sm"><span class="fa fa-check"></span></a>
                                                    <a onclick="return confirm('apakah anda yakin ingin menolak pengajuan mutasi ini?')" href="<?= base_url('manajer/mutasi_tolak/' . $d->no_urut) ?>" class="btn btn-danger btn-sm"><span class="fa fa-times"></span></a>
                                                <?php } ?>
                                                <?php if ($d->status_mutasi == 'diterima') { ?>
                                                    <button class="btn btn-primary btn-sm">Anda menerima pengajuan</button>
                                                <?php } ?>
                                                <?php if ($d->status_mutasi == 'ditolak') { ?>
