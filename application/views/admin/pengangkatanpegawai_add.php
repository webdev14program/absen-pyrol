            ...
            <div class="row">
                ...
                <section class="col-lg-12 connectedSortable">
                    ...
                    <div class="card">
                        ...
                        <form method="post" action="<?= base_url('admin/pengangkatan_simpan/') ?>">
                            <div class="card-body">
                                <div class="form-group">
                                    <label>Nama Pegawai</label>
                                    <select name="namapegawai" id="pilihpegawai" class="form-control" onchange="check()" required="">
                                        <option value=""></option>
                                        <?php foreach ($pegawai as $key) { ?>
                                            <option value="<?= $key->kode_pegawai ?>"><?= $key->kode_pegawai ?> - <?= $key->nama ?> </option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>Status Pegawai</label>
                                    <input type="text" name="statuspegawai" id="statuspegawai" class="form-control" required="" disabled>
                                </div>
                                <div class="form-group">
                                    <label>Departemen</label>
                                    <input type="text" name="departemen" id="departemen" class="form-control" required="" disabled>
                                </div>
                                <div class="form-group">
                                    <label>Jabatan</label>
                                    <input type="text" name="jabatan" id="jabatan" class="form-control" required="" disabled>
                                </div>
                                <div class="form-group">
                                    <label>Tanggal Pengangkatan Pegawai</label>
                                    <input type="date" name="tanggalpengangkatan" class="form-control" required="">
                                </div>
                            </div>
